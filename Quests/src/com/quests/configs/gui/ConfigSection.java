package com.quests.configs.gui;
...
import com.quests.GUI.GenerateItem;
import com.quests.GUI.PagedItem;
import com.quests.GUI.SpecialItem;
import com.quests.config.Config;
import com.quests.main.Quests;
import com.quests.utils.Communication;
import com.quests.utils.ComponentBuilder;
import com.quests.utils.Input;
...
public class ConfigSection extends ConfigGUI {
	...
	public List<PagedItem> Contents() {
		...
		this.configSection.getKeys(false).forEach(i -> {
			...
			ItemStack section = new ItemStack(Material.valueOf(Quests.getInstance().configManager.configs.Sections));
			ItemStack ints = new ItemStack(Material.valueOf(Quests.getInstance().configManager.configs.Numbers));
			ItemStack text = new ItemStack(Material.valueOf(Quests.getInstance().configManager.configs.Text));
			ItemStack booleanON = new ItemStack(Material.valueOf(Quests.getInstance().configManager.configs.BooleanON));
			ItemStack booleanOFF = new ItemStack(Material.valueOf(Quests.getInstance().configManager.configs.BooleanOFF));
			ItemStack lists = new ItemStack(Material.valueOf(Quests.getInstance().configManager.configs.Lists));
					...
					execution = () -> {
						...
						Communication.applyInput(player, new Input() {
							...
							public void onRecieve(String o) {
								...
								Bukkit.getScheduler().callSyncMethod(Quests.getInstance(), new Callable<Object>() {
									@Override
