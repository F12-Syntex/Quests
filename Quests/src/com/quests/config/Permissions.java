...
public class Permissions extends Config{
	...
	public String create = "battlepets.admin.creates";
	...
	public Permissions(String name, double version) {
		...
		this.items.add(new ConfigItem("Permissions.administration.create", create));
	...
	public void initialize() {
		...
		this.create = this.getConfiguration().getString("Permissions.administration.create");
